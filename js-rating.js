...
<style>.d,.a{width:200px}.r{display:flex;justify-content:space-around}.c{font-size:80%;max-width:800px;margin:auto;padding:20px;background:var(--bg);border-radius:8px;box-shadow:0 2px 5px rgba(0,0,0,0.1)}.s{margin-bottom:0!important}.s span{font-size:24px;color:lightgray}.d .bar{gap:12px;display:flex;margin:5px 0}.d .bar .bl{flex:1;margin:auto;height:10px;background:var(--shadow);border-radius:5px}.d .bar .bl.gold{background:gold}.d .bar .C{font-weight:bold}.reviews .v{padding:10px;border-top:1px solid var(--shadow)}.reviews .v:last-child{border-bottom:none}.reviews .s .gold{color:gold}.reviews p{margin:0 auto!important}.r1{position:relative;display:inline-block;font-size:30px}.g2{color:lightgray}.g1{color:gold}.h1{position:absolute;left:0}.s1:hover,.s1:focus{cursor:pointer}@media (max-width:768px){.c{margin:0 -8px;padding:8px}.r1,.s span,.s6{font-size:22px!important}.d .bar{gap:7px}}#rC{max-height:400px;overflow:auto}
#formU{height:0;overflow:hidden;background-color:var(--white);transition:height 0.5s ease;border-radius:10px;padding:0 20px;border:1px solid var(--shadow)}.s6{font-size:39px;color:lightgray;cursor:pointer}.s6.s7{color:gold}.s6:hover{cursor:pointer;color:gold}.s8{display:inline-block;direction:rtl}#ContactForm2{height:0;overflow:hidden}#ContactForm2_contact-form-submit{cursor:pointer;height:auto;font-size:120%;max-width:90%;padding:12px;width:464px}
...
<div id="formU"><div style="margin:30px auto;max-width:440px;"><h2 id="U9">Form Ulasan </h2><form id="rF6" onsubmit="return sR6();"><label>Tanggal:</label><input id="rD" name="rD" style="background-color:transparent;border-width:0px;" type="text" value="" /><br /><label>Nama:</label><input id="name" name="name" required="" style="background:var(--bg);color:var(--text);font-size:100%;max-width:90%;padding:12px;width:380px;" type="text" /><br /><br /><label>Pilih Bintang:</label><div class="s8"><span class="s6" d6="5">★</span><span class="s6" d6="4">★</span><span class="s6" d6="3">★</span><span class="s6" d6="2">★</span><span class="s6" d6="1">★</span></div><br /><label>Teks Ulasan:</label><br /><textarea id="rT8" name="rT8" required="" rows="4" style="background:var(--bg);color:var(--text);font-size:100%;max-width:90%;padding:12px;width:464px;"></textarea><br /></form><br /><div id="kirim2"></div><div id="kirim3"></div></div></div>
