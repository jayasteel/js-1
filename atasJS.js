...
document.getElementById("u5").innerHTML += "<div class='p3'><script src="https://www.jayasteel.com/feeds/posts/summary?max-results=2&amp;alt=json&amp;callback=pf"></" + "script></div>";
