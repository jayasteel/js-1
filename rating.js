...
document.getElementById("ula").innerHTML += `<title>Ulasan dan Rating</title>
...
document.head.insertAdjacentHTML('beforeend', `<style>.toggle-button{padding:10px 20px;background-color:#4CAF50;color:white;border:none;border-radius:5px;font-size:16px;cursor:pointer;transition:height .5s ease,opacity .5s ease}.toggle-button:hover{background-color:#45a049}</style>
