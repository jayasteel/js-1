...
// Mengatur isi #kirim2 menjadi sama dengan isi #ContactForm2_contact-form-submit tanpa menghapus #ContactForm2_contact-form-submit
...
`);
var sM = document.querySelector('.contact-form-success-message');
var target = document.getElementById('kirim3');
if (sM && target) {
    target.innerHTML = sM.innerHTML; // Salin isi .contact-form-success-message ke #kirim3
}
