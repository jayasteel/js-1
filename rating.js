...
// Fungsi untuk memperbarui tampilan bintang rating
...
// Event listener untuk memproses data pada hover tombol kirim
document.getElementById('ContactForm2_contact-form-submit').addEventListener('mouseover', function () {
    ...
    document.getElementById('ContactForm2_contact-form-email-message').value = 
        `Nama: ${document.getElementById('name').value}\n` +
        `Ulasan: ${document.getElementById('rT8')?.value || ''}\n` +
        `Bintang: ${RValue}\nTanggal: ${new Date().toISOString().split('T')[0]}\nUrl: ${window.location.href}`;
});

// Pindahkan tombol submit ke target yang diinginkan
if (document.getElementById('ContactForm2_contact-form-submit') && document.getElementById('kirim2')) {
    document.getElementById('kirim2').appendChild(document.getElementById('ContactForm2_contact-form-submit'));
}
